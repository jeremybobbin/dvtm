...
static KeyBinding bindings[] = {
	...
	{ NORMAL, { '0',               }, { view,           { NULL }                    } },
	{ INSERT, { KEY_F(1),          }, { view,           { tags[0] }                 } },
	{ INSERT, { KEY_F(2),          }, { view,           { tags[1] }                 } },
	{ INSERT, { KEY_F(3),          }, { view,           { tags[2] }                 } },
	{ INSERT, { KEY_F(4),          }, { view,           { tags[3] }                 } },
	{ INSERT, { KEY_F(5),          }, { view,           { tags[4] }                 } },
	{ NORMAL, { '0',               }, { view,           { NULL }                    } },
	{ NORMAL, { '\t',              }, { viewprevtag,    { NULL }                    } },
	{ NORMAL, { SHIFT('0')         }, { tag,            { NULL }                    } },
	TAGKEYS( '1',                              0)
	TAGKEYS( '2',                              1)
	TAGKEYS( '3',                              2)
	TAGKEYS( '4',                              3)
